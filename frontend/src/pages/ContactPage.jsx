...
const ContactPage = () => {
    ...
    const prefilledMessage = "Hello, I have a question from your website.";
        ...
        <div className="container mx-auto px-4 py-12">
            <div className="max-w-lg mx-auto text-center">
                ...
                <p className="text-lg text-gray-600 mb-8">
                    Have a question? The fastest way to reach us is via WhatsApp. Click the button below to start a chat with our support team.
                </p>
